...
const routes = [
  ...
  // Layout principal
  {
    ...
    children: [
      ...
      { path: 'dashboard-avanzado', name: 'dashboard-avanzado', component: () => import('@/views/reportes/DashboardAvanzadoView.vue'), meta: { requiresAuth: true } },
      { path: 'reportes', name: 'reportes', component: () => import('@/views/reportes/ReportesView.vue'), meta: { requiresAuth: true } },
